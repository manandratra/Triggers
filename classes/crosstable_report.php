...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("audit_vendeurs" == $this->xml_array['tables'][0])
			$isDB = true;
		if("recettes_jour" == $this->xml_array['tables'][0])
			$isDB = true;
		if("recettes_mois" == $this->xml_array['tables'][0])
			$isDB = true;
		if("recettes_vendeur_mois" == $this->xml_array['tables'][0])
			$isDB = true;
		if("recettes_vendeurs" == $this->xml_array['tables'][0])
			$isDB = true;
		if("vendeurs" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("recettes_vendeur_mois" == $this->xml_array['tables'][0])
			$isDB = true;
		if("vendeurs(triggers)_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("vendeurs(triggers)_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("vendeurs(triggers)_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("vendeurs(triggers)_users" == $this->xml_array['tables'][0])
