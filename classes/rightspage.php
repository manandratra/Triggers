...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "GroupID" ) .", ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "vendeurs(triggers)_uggroups" ) ." order by ". $grConnection->addFieldWrappers( "Label" );
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "vendeurs(triggers)_ugrights" )
...
//				continue;
	...
	{
		$rightWTableName = $this->connection->addTableWrappers( "vendeurs(triggers)_ugrights" );
