...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("recettes_vendeur_mois_Chart_chart","xt_showchart",array("chartname"=>"recettes_vendeur_mois_Chart","table"=>"recettes_vendeur_mois Chart","ctype"=>"2DPie"));
		}
