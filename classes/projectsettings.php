...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("vendeurs(triggers)_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "audit_vendeurs" ] = array( "url" => "audit_vendeurs", "type" => 0 );
	$projectEntitiesReverse[ "audit_vendeurs" ] = "audit_vendeurs";
	$projectEntities[ "recettes_jour" ] = array( "url" => "recettes_jour", "type" => 0 );
	$projectEntitiesReverse[ "recettes_jour" ] = "recettes_jour";
	$projectEntities[ "recettes_mois" ] = array( "url" => "recettes_mois", "type" => 0 );
	$projectEntitiesReverse[ "recettes_mois" ] = "recettes_mois";
	$projectEntities[ "recettes_vendeur_mois" ] = array( "url" => "recettes_vendeur_mois", "type" => 0 );
	$projectEntitiesReverse[ "recettes_vendeur_mois" ] = "recettes_vendeur_mois";
	$projectEntities[ "recettes_vendeurs" ] = array( "url" => "recettes_vendeurs", "type" => 0 );
	$projectEntitiesReverse[ "recettes_vendeurs" ] = "recettes_vendeurs";
	$projectEntities[ "vendeurs" ] = array( "url" => "vendeurs", "type" => 0 );
	$projectEntitiesReverse[ "vendeurs" ] = "vendeurs";
	$projectEntities[ "Dashboard" ] = array( "url" => "Dashboard", "type" => 4 );
	$projectEntitiesReverse[ "Dashboard" ] = "Dashboard";
	$projectEntities[ "recettes_vendeur_mois Chart" ] = array( "url" => "recettes_vendeur_mois_Chart", "type" => 3 );
	$projectEntitiesReverse[ "recettes_vendeur_mois_Chart" ] = "recettes_vendeur_mois Chart";
	$projectEntities[ "admin_rights" ] = array( "url" => "admin_rights", "type" => 1 );
	$projectEntitiesReverse[ "admin_rights" ] = "admin_rights";
	$projectEntities[ "vendeurs(triggers)_users" ] = array( "url" => "vendeurs_triggers__users", "type" => 0 );
	$projectEntitiesReverse[ "vendeurs_triggers__users" ] = "vendeurs(triggers)_users";
