...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("audit_vendeurs" == $this->chrt_array['tables'][0])
			return true;
		if("recettes_jour" == $this->chrt_array['tables'][0])
			return true;
		if("recettes_mois" == $this->chrt_array['tables'][0])
			return true;
		if("recettes_vendeur_mois" == $this->chrt_array['tables'][0])
			return true;
		if("recettes_vendeurs" == $this->chrt_array['tables'][0])
			return true;
		if("vendeurs" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("recettes_vendeur_mois" == $this->chrt_array['tables'][0])
			return true;
		if("vendeurs(triggers)_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("vendeurs(triggers)_users" == $this->chrt_array['tables'][0])
			return true;
		if("vendeurs(triggers)_users" == $this->chrt_array['tables'][0])
			return true;
		if("vendeurs(triggers)_users" == $this->chrt_array['tables'][0])
