...
require_once("include/vendeurs_triggers__users_variables.php");
...
$page_layouts["vendeurs_triggers__users_search"] = $layout;
...
$params['shortTableName'] = 'vendeurs_triggers__users';
