...
require_once("include/recettes_vendeur_mois_Chart_variables.php");
...
$layout = new TLayout("search_bootstrap", "ExtravaganzaOffice", "MobileOffice");
$layout->version = 3;
...
$page_layouts["recettes_vendeur_mois_Chart_search"] = $layout;
...
$params['shortTableName'] = 'recettes_vendeur_mois_Chart';
