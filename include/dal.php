...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("vendeurs(triggers)_users");
}
...
class tDAL
{
	var $tbltrigger_at_localhost__audit_vendeurs;
	var $tbltrigger_at_localhost__recettes_jour;
	var $tbltrigger_at_localhost__recettes_mois;
	var $tbltrigger_at_localhost__recettes_vendeur_mois;
	var $tbltrigger_at_localhost__recettes_vendeurs;
	var $tbltrigger_at_localhost__vendeurs;
	var $tbltrigger_at_localhost__vendeurs_triggers__uggroups;
	var $tbltrigger_at_localhost__vendeurs_triggers__ugmembers;
	var $tbltrigger_at_localhost__vendeurs_triggers__ugrights;
	var $tbltrigger_at_localhost__vendeurs_triggers__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "audit_vendeurs", "varname" => "trigger_at_localhost__audit_vendeurs", "altvarname" => "audit_vendeurs", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "recettes_jour", "varname" => "trigger_at_localhost__recettes_jour", "altvarname" => "recettes_jour", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "recettes_mois", "varname" => "trigger_at_localhost__recettes_mois", "altvarname" => "recettes_mois", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "recettes_vendeur_mois", "varname" => "trigger_at_localhost__recettes_vendeur_mois", "altvarname" => "recettes_vendeur_mois", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "recettes_vendeurs", "varname" => "trigger_at_localhost__recettes_vendeurs", "altvarname" => "recettes_vendeurs", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "vendeurs", "varname" => "trigger_at_localhost__vendeurs", "altvarname" => "vendeurs", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "vendeurs(triggers)_uggroups", "varname" => "trigger_at_localhost__vendeurs_triggers__uggroups", "altvarname" => "vendeurs_triggers__uggroups", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "vendeurs(triggers)_ugmembers", "varname" => "trigger_at_localhost__vendeurs_triggers__ugmembers", "altvarname" => "vendeurs_triggers__ugmembers", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "vendeurs(triggers)_ugrights", "varname" => "trigger_at_localhost__vendeurs_triggers__ugrights", "altvarname" => "vendeurs_triggers__ugrights", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
		$this->lstTables[] = array("name" => "vendeurs(triggers)_users", "varname" => "trigger_at_localhost__vendeurs_triggers__users", "altvarname" => "vendeurs_triggers__users", "connId" => "trigger_at_localhost", "schema" => "", "connName" => "trigger at localhost");
	}
