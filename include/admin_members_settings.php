...
$tdataadmin_members = array();
	...
	$tdataadmin_members[".OriginalTable"] = "vendeurs(triggers)_users";
...
if(mlang_getcurrentlang()=="")
{
	...
	$fieldToolTipsadmin_members[""] = array();
	$pageTitlesadmin_members[""] = array();
	$fieldLabelsadmin_members[""]["ID"] = "ID";
	$fieldToolTipsadmin_members[""]["ID"] = "";
	...
	$fieldLabelsadmin_members[""]["fullname"] = "Fullname";
	$fieldToolTipsadmin_members[""]["fullname"] = "";
	$fieldLabelsadmin_members[""]["groupid"] = "Groupid";
	$fieldToolTipsadmin_members[""]["groupid"] = "";
	$fieldLabelsadmin_members[""]["active"] = "Active";
	$fieldToolTipsadmin_members[""]["active"] = "";
...
$tdataadmin_members[".strOriginalTableName"] = "vendeurs(triggers)_users";
...
$tdataadmin_members[".sqlFrom"] = "FROM `vendeurs(triggers)_users`";
