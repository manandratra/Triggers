...
$tdataadmin_users = array();
	...
	$tdataadmin_users[".OriginalTable"] = "vendeurs(triggers)_users";
...
if(mlang_getcurrentlang()=="")
{
	...
	$fieldToolTipsadmin_users[""] = array();
	$pageTitlesadmin_users[""] = array();
	$fieldLabelsadmin_users[""]["ID"] = "ID";
	$fieldToolTipsadmin_users[""]["ID"] = "";
	...
	$fieldLabelsadmin_users[""]["fullname"] = "Fullname";
	$fieldToolTipsadmin_users[""]["fullname"] = "";
	$fieldLabelsadmin_users[""]["groupid"] = "Groupid";
	$fieldToolTipsadmin_users[""]["groupid"] = "";
	$fieldLabelsadmin_users[""]["active"] = "Active";
	$fieldToolTipsadmin_users[""]["active"] = "";
...
$tdataadmin_users[".strOriginalTableName"] = "vendeurs(triggers)_users";
...
$tdataadmin_users[".sqlFrom"] = "FROM `vendeurs(triggers)_users`";
