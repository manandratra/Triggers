...
class AuditTrailTable
{
	...
	{
		if($table=="audit_vendeurs")
		{
			return false;
		}
		if($table=="recettes_jour")
		{
			return false;
		}
		if($table=="recettes_mois")
		{
			return false;
		}
		if($table=="recettes_vendeur_mois")
		{
			return false;
		}
		if($table=="recettes_vendeurs")
		{
			return false;
		}
		if($table=="vendeurs")
		...
		if($table=="recettes_vendeur_mois Chart")
		{
			return false;
		}
		...
		if($table=="vendeurs(triggers)_users")
		{
			return false;
		}
