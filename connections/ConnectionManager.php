...
class ConnectionManager
{
	...
	{
		return $this->byId( "trigger_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "trigger_at_localhost";
		$data["connName"] = "trigger at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;trigger;;1"; //currently unused
		
		$this->_connectionsIdByName["trigger at localhost"] = "trigger_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "trigger";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=trigger;OPTION=3";
		// encription set
		...
		$connectionsData["trigger_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["audit_vendeurs"] = "trigger_at_localhost";
		$connectionsIds["recettes_jour"] = "trigger_at_localhost";
		$connectionsIds["recettes_mois"] = "trigger_at_localhost";
		$connectionsIds["recettes_vendeur_mois"] = "trigger_at_localhost";
		$connectionsIds["recettes_vendeurs"] = "trigger_at_localhost";
		$connectionsIds["vendeurs"] = "trigger_at_localhost";
		$connectionsIds["recettes_vendeur_mois Chart"] = "trigger_at_localhost";
		$connectionsIds["admin_rights"] = "trigger_at_localhost";
		$connectionsIds["vendeurs(triggers)_users"] = "trigger_at_localhost";
		$connectionsIds["admin_members"] = "trigger_at_localhost";
		$connectionsIds["admin_users"] = "trigger_at_localhost";
