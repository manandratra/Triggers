...
$nonAdminTablesArr[] = "audit_vendeurs";
$nonAdminTablesArr[] = "recettes_jour";
$nonAdminTablesArr[] = "recettes_mois";
$nonAdminTablesArr[] = "recettes_vendeur_mois";
$nonAdminTablesArr[] = "recettes_vendeurs";
$nonAdminTablesArr[] = "vendeurs";
$nonAdminTablesArr[] = "Dashboard";
$nonAdminTablesArr[] = "recettes_vendeur_mois Chart";
$nonAdminTablesArr[] = "vendeurs(triggers)_users";
...
$wGroupTableName = $ug_connection->addTableWrappers( "vendeurs(triggers)_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "vendeurs(triggers)_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "vendeurs(triggers)_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "vendeurs(triggers)_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "vendeurs(triggers)_ugmembers" );
