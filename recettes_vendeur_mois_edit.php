...
require_once("include/recettes_vendeur_mois_variables.php");
...
$layout = new TLayout("edit_bootstrap", "ExtravaganzaOffice", "MobileOffice");
$layout->version = 3;
...
$page_layouts["recettes_vendeur_mois_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap3", "ExtravaganzaOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
...
$page_layouts["recettes_vendeur_mois_list"] = $layout;
...
$keys = array();
$keys["rc_year"] = postvalue("editid1");
$keys["rc_month"] = postvalue("editid2");
$keys["vd_id"] = postvalue("editid3");
